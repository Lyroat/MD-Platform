-- MD-Platform Initial Schema
-- Users, Comments, and Collaboration Documents
...
-- Collaboration documents (Yjs state storage, replaces .yjs files)
...
-- NextAuth sessions support (JWT-based, minimal)
